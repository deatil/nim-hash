...
block: # "streaming":
  ...
  check SM3SecureHash(state.finalize()) == parseSecureHash("1ab21d8355cfa17f8e61194831e81a8f22bec8c728fefb747ed035eb5082aa2b")
  
  var state2 = newSM3State()
  state2.update("abc")
  check SM3SecureHash(state2.finalize()) == parseSecureHash("66c7f0f462eeedd9d1f2d46bdc10e4e24167c4875cf2f7a2297da02b8f4ba8e0")
  
  var state3 = newSM3State()
  state3.update("a")
  state3.update("b")
  state3.update("c")
  check SM3SecureHash(state3.finalize()) == parseSecureHash("66c7f0f462eeedd9d1f2d46bdc10e4e24167c4875cf2f7a2297da02b8f4ba8e0")
...
block: # "isValidHash":
  check not isValidSM3Hash("")
  check not isValidSM3Hash("66C7F0F462EEEDD9D1F2D46BDC10E4E24167C4875CF2F7A2297DA02B8F4BA8E01")
  check not isValidSM3Hash("66C7F0F462EEGDD9D1F2D46BDC10E4E24167C4875CF2F7A2297DA02B8F4BA8E0")
  check isValidSM3Hash("66C7F0F462EEEDD9D1F2D46BDC10E4E24167C4875CF2F7A2297DA02B8F4BA8E0")
  check isValidSM3Hash("66c7f0f462eeedd9d1f2d46bdc10e4e24167c4875cf2f7a2297da02b8f4ba8e0")
  check isValidSM3Hash("66c7f0f462eeedd9D1F2D46BDC10E4E24167C4875CF2F7A2297DA02B8F4BA8E0")
